...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWndEx)
	...
	ON_WM_SETTINGCHANGE()
	ON_BN_CLICKED(IDC_MYBUTTON, &CMainFrame::OnButtonClick) // 11.23
END_MESSAGE_MAP()
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_btnMove.Create(_T("간지소"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
		CRect(100, 50, 500,500), this, IDC_MYBUTTON))
	{
		TRACE0("버튼 생성 실패\n");
		return -1;
	}
